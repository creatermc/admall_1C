...
Procedure WriteCOMClassAndCloseForm(Command)
	...
	If CheckFilling() Then
		If IsAllowedCOMClassNameUnique() Then
			...
			Except
				Message(Nstr("ru = 'Идентификатор объекта задан неверно.
						|Пример правильного идентификатора:A16C48CA-EF33-41B9-87B9-95A51190AE0D.';SYS=''", "ru"));
				Return;
			EndTry;
		...
		Else
			...
			|Введите уникальное имя или перейдите к изменению существующего COM-класса.';SYS=''", "ru"));
		EndIf;
	EndIf;
EndProcedure
